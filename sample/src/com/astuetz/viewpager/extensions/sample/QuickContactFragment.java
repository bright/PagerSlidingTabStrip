...
public class QuickContactFragment extends DialogFragment {
    ...
    public class ContactPagerAdapter extends PagerAdapter implements PagerSlidingTabStrip.CustomTabsViewPagerAdapter {
        ...
        private final PagerSlidingTabStrip.TabViewProvider tabViewProvider = new PagerSlidingTabStrip
                .IconTabViewProvider() {
            @Override
        ...
        @Override
        public PagerSlidingTabStrip.TabViewProvider getViewProvider(int position) {
